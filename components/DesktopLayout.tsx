					...
					<aside className='w-[320px] lg:w-[360px] xl:w-[420px] bg-[#1a1a1a] text-white flex flex-col shrink-0 border-r border-black/30 dark:border-white/10'>
						<div className='relative aspect-[4/5] w-full bg-zinc-800 overflow-hidden'>
							<img
								...
								className='absolute inset-0 w-full h-full object-cover object-top transform-gpu scale-100 transition-[opacity,transform] duration-700 opacity-100 dark:opacity-0'
								decoding='async'
								loading='eager'
							...
							<img
								alt=''
								aria-hidden='true'
								className='absolute inset-0 w-full h-full object-cover object-top transform-gpu scale-[1.1] transition-[opacity,transform] duration-700 opacity-0 dark:opacity-100'
								decoding='async'
								loading='eager'
						...
						<div className='p-10 xl:p-12 bg-primary'>
							...
							<p className='text-[0.72rem] tracking-[0.34em] uppercase font-semibold text-zinc-400'>
								{content.hero.subtitle}
							</p>
						</div>

						<div className='p-10 xl:p-12 flex-grow bg-zinc-900'>
							<h2 className='text-[0.68rem] font-semibold tracking-[0.24em] uppercase mb-8 text-zinc-500'>
								{content.desktop.experienceTitle}
							</h2>
									...
									{content.contacts.map(contact => (
										...
										>
											<div className='w-10 h-10 rounded-full border border-zinc-500/70 dark:border-zinc-300/35 bg-white/45 dark:bg-zinc-800/70 text-zinc-800 dark:text-zinc-100 flex items-center justify-center mr-4 group-hover:bg-primary group-hover:border-primary group-hover:text-white transition-colors'>
												<i
													className={`${contact.icon} text-[0.95rem]`}
													aria-hidden='true'
												></i>
											</div>
											<span className='text-lg font-semibold text-zinc-800 dark:text-zinc-100 tracking-[0.01em]'>
												{contact.value}
											</span>
										</a>
									))}
